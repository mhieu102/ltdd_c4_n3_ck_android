    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.help, color: _getIconColor(1)), // Icon cho Hướng dẫn
            label: 'Hướng dẫn', // Label mới
          ),
          BottomNavigationBarItem(
...
//     const DriverGuideScreen(), // Thay thế cho Tài khoản
//
//     const AccountScreen(),
//
//     const MarketScreen(),
...
//           BottomNavigationBarItem(
//
//             icon: Icon(Icons.help, color: _getIconColor(2)), // Icon cho Hướng dẫn
//
//             label: 'Hướng dẫn', // Label mới
//
//           ),
